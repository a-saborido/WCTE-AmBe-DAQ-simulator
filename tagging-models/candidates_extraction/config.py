...
# Input samples and their AmBe source positions. Positions are stored in cm,
# matching the PMT geometry and all reconstructed vertices.
INPUT_SAMPLES = [
    {
        "path": REPO_DIR / "data" / "wcte_ambe_mc_plus_clean_bkg_pe_2386_TRAIN.root",
        "prompt_vertex_cm": (0.0, 30.5, 0.0),
    },
    {
        "path": REPO_DIR / "data" / "wcte_ambe_mc_plus_clean_bkg_pe_2387_TRAIN.root",
        "prompt_vertex_cm": (0.0, -30.5, 0.0),
    },
    {
        "path": REPO_DIR / "data" / "wcte_ambe_mc_plus_clean_bkg_pe_2388_TRAIN.root",
        "prompt_vertex_cm": (0.0, -58.5, 0.0),
    },
    {
        "path": REPO_DIR / "data" / "wcte_ambe_mc_plus_clean_bkg_pe_2389_TRAIN.root",
        "prompt_vertex_cm": (-47.64, 30.5, 29.17),
    },
    {
        "path": REPO_DIR / "data" / "wcte_ambe_mc_plus_clean_bkg_pe_2390_TRAIN.root",
        "prompt_vertex_cm": (-47.64, -30.5, 29.17),
    },
]
