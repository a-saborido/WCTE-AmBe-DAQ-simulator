...
`candidates_extraction/config.py`. The BDT can use any subset selected independently in
...
The main observable thresholds and geometry placeholders live in `candidates_extraction/config.py`
